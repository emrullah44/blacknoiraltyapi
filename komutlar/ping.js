...
exports.run = async (client, message, args) => {
   var olcum = await message.channel.send( ' **Ölçüm yapılıyor, lütfen bekleyiniz...:timer:**');
 var sonuc = await message.channel.send( " **Veriler alındı...:memo:**").then(msg => msg.delete(3000))
